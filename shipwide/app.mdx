...
codebase across web, mobile and desktop. The code is the source of truth.

## Building blocks & intentional stubs

Every exported composable, component, api function and type is a **ready-to-use building
block** — wire it up when you need it. The account / sessions / settings screens
(`views/pages/account/*`, `_settings/AccountSettings.vue`) are **placeholder stubs on
purpose**: you build your product screens on top; the kit supplies the plumbing behind them.
